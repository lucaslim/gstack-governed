...
1. [CRITICAL] src/components/PostEditor.tsx:42 — Race condition in status transition
...
- **Every finding needs evidence.** Cite file:line and explain why it's a problem. Never post vague findings.
